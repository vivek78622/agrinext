...
import { PrescreenResponse, CropCandidate } from "@/types";
import EnvironmentalLoadingScreen from "@/components/EnvironmentalLoadingScreen";
import Phase1RainfallAnalysis from "@/components/Phase1RainfallAnalysis";
...
function CropAnalysisContent() {
    ...
    // Filter + Search Logic
    const filteredCrops = data?.candidates.filter(c => {
        // Filter tab
        ...
        if (searchQuery.trim()) {
            ...
            return (
                ...
                c.season.some(s => s.toLowerCase().includes(q)) ||
